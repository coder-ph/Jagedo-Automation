...
const serviceTypes = ["Fundi", "Professional", "Hardware", "Contractor"];
            ...
            <div className="flex justify-center items-start">
              <div className="text-center">
                ...
                <p className="mt-2 opacity-90">
                  Fill in the details below and we'll connect you with the right
                  service provider
                </p>
              </div>
            </div>
                          ...
                          {formData.materialDocuments.length > 0 && (
                            <div className="space-y-2">
                              ...
                              <ul className="space-y-1">
                                {formData.materialDocuments.map(
                                  (file, index) => (
                                    <li
                                      key={index}
                                      className="flex items-center justify-between p-2 bg-gray-50 rounded-md group hover:bg-gray-100 transition-colors duration-150"
                                    >
